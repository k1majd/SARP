...
def buildModelWindow(
    ...
    last_pred_layer = build_network_block(
        regularizer_rate,
        pred_layer_size,
        layers.Concatenate()([last_ctrl_layer, input_layer[:, -8:]]),  # we only input the state of last step instead of the last 10 steps
...
if __name__ == "__main__":
    ...
    trained_time_str = "_2_24_2023_14_30_16"  # trained model
