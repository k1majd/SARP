...
if __name__ == "__main__":
    ...
    if not os.path.exists(current_dir + f"/trained_models/policy_full_obs"):
        os.makedirs(current_dir + f"/trained_models/policy_full_obs")
    keras.models.save_model(
        model,
        f"{current_dir}/trained_models/policy_full_obs/model",
        overwrite=True,
